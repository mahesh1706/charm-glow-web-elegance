...
const ClassesSection = () => {
  ...
  const classesData: ClassItem[] = [
    {
      ...
      price: "999",
      syllabus: ["Body measurement","Prepleat","Ironing","Boxing","Packing","Draping","Covered"]
    },
    {
      name: "Self grooming",
      price: "1000",
    ...
    },
    {
      ...
      price: "7000",
      syllabus: [
        "1.threading","2 dtan","3. Facial","4. bleach","5. basic haircuts",
        "6. honey wax","7. hairdye application","8. manicure pedicure"
      ]
    },
    {
      ...
      price: "35000",
      syllabus: [
        "1. All basic syllabus","2. advanced facial with acupressure","3. galvanic facial",
        "4. high frequency facial","5. pimple treatment","6. hydra facial",
        "7. micro needling skin treatment","8. chemical peel","9. melisma treatment",
        "10. henna prepping and application","11. advanced roll on wax",
        "12. crystal pedicure manicure","13. hair spa","14. advanced haircut",
        "15. blow dry setting","16. hair colouring","17. hair highlights",
        "18. dandruff treatment","19. smoothening and straightening","20. keratin",
        "21. hair Botox","22. head massage with acupressure","23. skin aesthetic treatments",
        "24. mda treatment","25. rf and electro portion treatment","26. Bollywood facial",
        "27. hair growth treatment","28. undereye treatment","29. pigmentation treatment",
        "30. health and hygiene","31. social media management","32. shop and license knowledge",
        "33. msme registration","34. government certification"
      ]
    },
    {
      ...
      price: "15000",
      syllabus: [
        "1.non Hd makeup","2. Waterproof sweat proof makeup","3. HD makeup",
        "4. skinglow makeup","5. matte Hd look","6. sculpting contouring technique",
        "7. techniques and customerization","8. 10 hairstyles ( bridal)",
        "9.  saree pre  pleating and bridal draping","10. 5 types of saree draping",
    ...
    },
    {
      ...
      price: "30000",
      syllabus: [
        "1. Glass skin makeup","2. celebrity makeup","3. international HD signature style",
        "4. airbrush makeup","5. Advanced hairstyles 10",
        "6. pulling technique and messy look technique and different curl technique",
        "Free products with free portfolio","Shoots"
      ]
    }
  ];
  ...
  // ---- Badge color control (change 'red' to 'green' if you prefer) ----
  const BADGE_COLOR: 'red' | 'green' = 'red';
  const badgeClasses =
    BADGE_COLOR === 'red'
  ...
  const features = [
    { icon: <GraduationCap className="w-8 h-8 text-jewel-blue" />, title: "Expert Training", description: "Learn from industry professionals with years of experience" },
    { icon: <BookOpen className="w-8 h-8 text-jewel-blue" />, title: "Comprehensive Curriculum", description: "Detailed course materials and hands-on practice sessions" },
    { icon: <Users className="w-8 h-8 text-jewel-blue" />, title: "Small Batches", description: "Personalized attention with limited students per batch" },
    { icon: <Award className="w-8 h-8 text-jewel-blue" />, title: "Certification", description: "Industry-recognized certification upon course completion" }
  ];
            ...
            <div className="space-y-4 mb-8">
              {classesData.map((course, index) => (
                <button
                  ...
                  aria-label={`View curriculum for ${course.name}`}
                  ...
                  ref={index === 0 ? lastFocusedRef : undefined}
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="min-w-0">
                      <h4 className="font-inter font-semibold text-soft-brown mb-1 truncate">
                        {course.name}
                      </h4>
                      ...
                      {/* Mobile badge (below text) */}
                      <span
                        className={`sm:hidden inline-flex items-center gap-1 mt-2 px-3 py-1 rounded-full text-xs font-semibold text-white shadow ${badgeClasses} transition-colors`}
                      >
                    ...
                    {/* Price + Desktop badge on the right */}
                    <div className="flex items-center gap-3 shrink-0">
                      <span className="text-sm font-medium text-jewel-blue">
                        {formatINR(course.price)}
                      </span>
                      <span
                        className={`hidden sm:inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold text-white shadow ${badgeClasses} transition-colors`}
                      >
                        <BookOpen className="w-3.5 h-3.5" />
                        View Curriculum
                      </span>
              ...
              <DrawerContent className="h-[90vh]">
                <DrawerHeader className="flex items-center justify-between">
                  <div className="flex items-baseline gap-3">
                    <DrawerTitle id="class-detail-title" className="font-playfair text-soft-brown">
                      {selected.name}
                    </DrawerTitle>
                ...
                <div className="px-6 pb-6 overflow-y-auto">
                  <ul className="list-disc pl-6 space-y-2 text-soft-brown/80">
                    {selected.syllabus.map((item, idx) => <li key={idx}>{item}</li>)}
                  </ul>
                </div>
              </DrawerContent>
            </Drawer>
            ...
            >
              <DialogContent aria-labelledby="class-detail-title" className="max-w-3xl w-[92vw] max-h-[80vh] overflow-hidden">
                <DialogHeader className="flex flex-row items-center justify-between">
                  <div className="flex items-baseline gap-3">
                    <DialogTitle id="class-detail-title" className="font-playfair text-soft-brown">
                      {selected.name}
                    </DialogTitle>
                    <span className="text-jewel-blue font-semibold">{formatINR(selected.price)}</span>
                  </div>
